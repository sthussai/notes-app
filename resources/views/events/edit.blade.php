...
<div class="w3-center    w3-panel w3-card">
  ...
  <div>
    <form action="/events/{{ $event->id }}" method="POST"
      ...
      <div class="w3-row w3-section">
        ...
        <div class="w3-rest">
          <textarea class="w3-input w3-border" name="description" type="text" placeholder="Event Description"
      ...
      <div class="w3-row w3-section">
        ...
        <div class="w3-rest">
          ...
          <input class="w3-input w3-border" name="tags" type="text" placeholder="Edit Tags"
            value="@foreach($event->tags as $tag)
        {{ $tag->name . ',' }}
        @endforeach">
  ...
  <p class="w3-center">
    ...
    <a href='/events' class="w3-button w3-section w3-blue w3-ripple"> Back </a>
  </p>
  </form>
